...
const WaveformDisplay = ({ audioData, color = '#3b82f6', // Default blue-500
className, backgroundColor = 'transparent', // Default transparent
 }) => {
    ...
    return (_jsx("canvas", { ref: canvasRef, className: cn("w-full h-16 rounded-md", className), 
