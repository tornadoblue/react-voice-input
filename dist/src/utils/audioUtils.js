 ...
 */
export function findLastSoundEndTime(audioBuffer, minTrailingSilenceDuration = 0.5, // Minimum silence at the very end to consider it "trailing"
silenceThreshold = 0.01, analysisChunkDuration = 0.05 // Analyze in 50ms chunks
) {
...
export function trimAudioBuffer(originalBuffer, newDurationInSeconds) {
    ...
    try {
        ...
        const newBuffer = tempAudioContext.createBuffer(numberOfChannels, newLengthInSamples, sampleRate);
